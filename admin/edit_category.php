...
<?php
    ...
    if(isset($_POST['btnUpdateCategory'])){
        ...
        $category->set('modified_at', date('Y-m-d H:i:s'));

        if(count($error) == 0){
            $resultStatus = $category->edit();
            $resultStatus;
        }
    }
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <form  method="post" action="">
                                ...
                                <div class="form-group">
                                    <label>Rank</label>
                                    <input type="number" name="rank" class="form-control" value="<?php echo $data[0]->rank; ?>">
                                ...
                                <button type="submit" name="btnUpdateCategory" class="btn btn-success">Update Category</button>
                            </form>
